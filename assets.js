            ...
            for (let i = 1; i < jsonData.length; i++) {
                ...
                headers.forEach((header, index) => {
                    ...
                    switch(header) {
                        ...
                        case 'price':
                        case 'unit price':
                            assetData.price = Number(value) || 0;
                            break;
                        case 'qty_initial':
                        case 'qty initial':
                        case 'initial quantity':
                            assetData.qtyInitial = Number(value) || 0;
                            break;
                        case 'qty_add':
                        case 'qty add':
                        case 'additional quantity':
                            assetData.qtyAdd = Number(value) || 0;
                            break;
                        case 'qty_lost':
                        case 'qty lost':
                        case 'lost quantity':
                            assetData.qtyLost = Number(value) || 0;
                            break;
                        case 'purchased_on':
                        case 'purchased on':
                        case 'purchase date':
                        ...
                        case 'life time':
                        case 'lifetime':
                            assetData.lifeTime = Number(value) || 1;
                            break;
                    }
                });
